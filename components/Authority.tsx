...
import { CheckCircle2, Star, Trophy, Award } from './ui/Icons';
      ...
      <section className="bg-brand-gray py-12 border-b border-gray-800">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 text-white">
            <div className="flex items-center gap-4 bg-brand-dark p-6 rounded-lg shadow-lg border border-gray-800">
